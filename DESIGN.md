---
version: alpha
name: Retro Cute Portfolio
description: Installed from VoltAgent awesome-design-md's Nintendo.com (2001) DESIGN.md, then adapted for a retro-cute playable portfolio inspired by Peter Oravec's pixel-art portfolio and the provided palette: cream paper, grass green, toy blue, ink navy, and candy pink.

colors:
  primary: "#508124"          # Toy grass green — main chrome, map edges, selected states
  signal: "#E570A5"           # Candy pink — interactive cues, item markers, playful accents
  amber: "#F2E5BE"            # Cream highlight — labels, tabs, raised text
  nav-gold: "#F2E5BE"         # Cream nav text
  canvas: "#5891BA"           # Toy blue — main panel and sky surface
  canvas-soft: "#E9DDB8"      # Warm cream paper — page background
  sky: "#5891BA"              # Blue alias
  lavender: "#E570A5"         # Pink hero field
  ice: "#E9DDB8"              # Cream inset panels
  periwinkle: "#5891BA"       # Blue raised panels
  chrome-indigo: "#131322"    # Ink navy — outlines, chrome borders, shadows
  muted-indigo: "#3b3a4a"     # Soft ink — inactive tabs and secondary labels
  platinum: "#F2E5BE"         # Cream card surface
  surface: "#ffffff"          # White — content cards, list-row highlight
  carbon: "#131322"           # Ink navy — nav bar, dark buttons, footer, ink
  hairline: "#131322"         # heavy cartoon outline
  ink: "#131322"              # primary text on light
  ink-soft: "#508124"         # secondary text / chrome labels
  on-primary: "#ffffff"       # text on dark/red/orange chrome
  systems-teal: "#5891BA"     # toy blue circuit-board field
  games-red: "#E570A5"        # pink hero/action field
  error: "#E570A5"            # validation / destructive
